...
| `experiments/fuzzer_v0/family_a/activation_rereview/` | independent amendment re-review, source lock, checklist, tests, decision, authorization boundary, and zero-attempt ledger | `DECLINE_IMPLEMENTATION_NOT_READY`; nine blockers; qualification not authorized |
