...
| C1 concurrency | `IN_PROGRESS` | 6 / 15 | 9 / 30 | 1 configuration failure, 2 observability rejections | C/A-first PASS |
...
Record and push `C1-C-A_FIRST`, confirm clean synchronization, then run
`C1-C-NEAR_SIMULTANEOUS` attempt 1 with seed `320311`.
