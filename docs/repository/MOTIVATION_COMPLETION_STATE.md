...
| C1 concurrency | `IN_PROGRESS` | 5 / 15 | 8 / 30 | 1 configuration failure, 2 observability rejections | Pair B 3/3 PASS; no violations |
...
Checkpoint and push closed pair B, confirm clean synchronization, then run
`C1-C-A_FIRST` attempt 1 with seed `320301`.
