...
| C1 concurrency | `IN_PROGRESS` | 7 / 15 | 10 / 30 | 1 configuration failure, 2 observability rejections | C/A-first and C/near PASS |
...
Record and push `C1-C-NEAR_SIMULTANEOUS`, confirm clean synchronization, then
run `C1-C-B_FIRST` attempt 1 with seed `320321`.
