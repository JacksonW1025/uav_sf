...
| C1 concurrency | `IN_PROGRESS` | 8 / 15 | 11 / 30 | 1 configuration failure, 2 observability rejections | Pair C 3/3 PASS; no violations |
...
Checkpoint and push closed pair C, confirm clean synchronization, then run
`C1-D-A_FIRST` attempt 1 with seed `320401`.
