...
| C1 concurrency | `IN_PROGRESS` | 4 / 15 | 7 / 30 | 1 configuration failure, 2 observability rejections | B/A-first and B/near PASS |
...
Record and push `C1-B-NEAR_SIMULTANEOUS`, confirm clean synchronization, then
run `C1-B-B_FIRST` attempt 1 with seed `320221`.
