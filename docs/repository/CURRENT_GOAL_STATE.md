...
- Repository checkpoint commit: `ef7e3d5646a0ceabe133314407c345d08a529bbe`
...
- Partial paired cells: v5 `p5_t1_hover_pair_r4` has valid Dynamic attempt 1,
  Offboard attempt 1 excluded as an environment failure, and clean Offboard
  attempt 2 excluded because its clock bridge was degraded; v4
...
- Pending paired cells: first missing side is v5 r4 Offboard attempt 3, then
...
- Next exact action: checkpoint Offboard attempt 2 as measurement-unknown, then
  retry only its Offboard side as attempt 3; do not rerun valid Dynamic attempt 1
- Last update: 2026-07-17T13:49:16-07:00
