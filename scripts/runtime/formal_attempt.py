#!/usr/bin/env python3
"""Run, close, and account for one preregistered formal Family A attempt."""
...
def run(args: argparse.Namespace) -> dict[str, Any]:
    ...
    if len(cell_attempts) >= int(cell["launch_cap"]):
        raise FormalAttemptError("cell launch cap is exhausted: MEASUREMENT_INSUFFICIENT")
    ...
    closure = {
        ...
        "image_id": image_id,
        "runtime_driver_returncode": launch.returncode,
